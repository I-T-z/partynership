...
public class FreeBoardActivity extends AppCompatActivity {
    ...
    private List<FreeListItem> generateItemsList() {
        ...
        fList.add(new FreeListItem("1", "[자랑]", "가챠성공", "뭉가", "2024-01-29 00:01:23"));
        fList.add(new FreeListItem("2", "[자랑]", "가챠성공", "뭉가", "2024-01-29 00:01:23"));
        fList.add(new FreeListItem("3", "[자랑]", "가챠성공", "뭉가", "2024-01-29 00:01:23"));
        fList.add(new FreeListItem("4", "[자랑]", "가챠성공", "뭉가", "2024-01-29 00:01:23"));
